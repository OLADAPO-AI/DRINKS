      ...
      <div className=" w-auto h-auto flex flex-row">
        <div className="  mx-auto p-6 rounded-xl shadow-2x1 bg-slate-950 ">
          <div className=" mt-[40px] flex flex-row gap-3 items-center">
            <div className=" w-10 h-10 rounded-3xl border-2 border-sky-600 font-[700] text-[16px] leading-[19.2px] text-center items-center flex flex-row justify-center">
              1
            </div>
            <h3 className=" font-[700] text-[18px] leading-[21.6px]">
              Our Newsletter
            </h3>
          </div>
